  ...
  return (
    <>
        <DataTable
          ...
          rowClassName={(item: any) => (editingId === item.id || isMassEditing) ? 'bg-indigo-50/30 dark:bg-indigo-900/20' : ''}
          className="bg-white dark:bg-slate-800 rounded-[32px] border border-slate-100 dark:border-slate-700 shadow-2xl shadow-slate-200/40 dark:shadow-slate-900/50 overflow-hidden relative animate-in zoom-in-95 duration-500"
