...
- Workspace ID: `29ef7435-713c-4b51-84e0-1cedb16438b5`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/29ef7435-713c-4b51-84e0-1cedb16438b5.
...
2. `npx ngodingpakeai connect --workspace 29ef7435-713c-4b51-84e0-1cedb16438b5 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/29ef7435-713c-4b51-84e0-1cedb16438b5. Only pass on links the CLI actually printed — never assemble one from an id yourself.
